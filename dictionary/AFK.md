---
description: "使用者啟動工作階段後離開鍵盤，讓代理人無人監督執行的工作模式。"
aliases:
  - away from keyboard
  - AFK (away from keyboard)
---

離開鍵盤（Away from keyboard）。一種工作模式：使用者啟動一個[工作階段](./Session.md)後便離開，讓[代理人](./Agent.md)在無人監督下持續執行。這是 AI Coding 的吞吐量倍增器——在你睡覺、吃飯或處理其他事情時，可以同時並行執行多個 AFK 工作階段。通常需要寬鬆的[權限模式](./Permission%20mode.md)搭配[沙盒](./Sandbox.md)機制才能安全運作。
